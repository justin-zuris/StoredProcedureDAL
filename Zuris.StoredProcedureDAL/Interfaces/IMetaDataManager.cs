...
namespace Zuris.SPDAL
{
    public interface IMetaDataManager
    {
        ...
        bool ProcedureExists(string schemaName, string procedureName);

        ProcedureInfo GetProcedureInfo(string procedureName);

        ProcedureInfo GetProcedureInfo(string schemaName, string procedureName);

        List<ProcedureInfo> GetProcedureInfo();
    }
}
...
/*
    ...
    public class MetaDataManager : IMetaDataManager
    {
        ...
        public MetaDataManager(IDataManager dataManager)
        {
            _mgr = dataManager;
        }
